const { Post, User, Like, Follow } = require("../models/Index")
...
module.exports = { getProfile, getProfileByUsername, followUser, unfollowUser, updateProfilePhoto, deleteProfilePhoto, searchUsers }